Public Class Q06
    Friend Q6GamePlay(13) As String 'declare gameplay as string
    ...
    Private Sub Q06_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'transfer Friend Varables from Question 5
        GPlayersRemaining = Q05.GPlayersRemaining
        GPlayerNumber = Q05.GPlayerNumber
        questionsRemaining = Q05.questionsRemaining
        SHQuestionsRemaining = Q05.SHQuestionsRemaining
        passUsage = Q05.passUsage
        AskFriendCount = Q05.AskFriendCount
        DoubleDipCount = Q05.DoubleDipCount
        TopPrizeAmount.Text = Q05.TopPrizeAmount.Text
        Trust = Q05.Trust
        ...
        ElseIf GPlayersRemaining = 3 Then
            If Q05.QuestionValue.Text = "¥1,000" Then
    ...
    Sub QuestionLoading()
        ...
        Topic.Text = Q6GamePlay(0)
        Question1.Text = Q6GamePlay(1)
        Question2.Text = Q6GamePlay(2)
        Question3.Text = Q6GamePlay(3)
        ChoiceA.Text = Q6GamePlay(4)
        ChoiceB.Text = Q6GamePlay(5)
        ChoiceC.Text = Q6GamePlay(6)
        ChoiceD.Text = Q6GamePlay(7)
        PlayerScreen.Topic.Text = Q6GamePlay(0)
        PlayerScreen.question(0) = Q6GamePlay(1)
        PlayerScreen.question(1) = Q6GamePlay(2)
        PlayerScreen.question(2) = Q6GamePlay(3)
        PlayerScreen.question(3) = Q6GamePlay(4)
        PlayerScreen.question(4) = Q6GamePlay(5)
        PlayerScreen.question(5) = Q6GamePlay(6)
        PlayerScreen.question(6) = Q6GamePlay(7)
        ...
        CountA = CInt(Q6GamePlay(9))
        CountB = CInt(Q6GamePlay(10))
        CountC = CInt(Q6GamePlay(11))
        CountD = CInt(Q6GamePlay(12))
        ...
        Select Case ButtonCount
            ...
            Case 2
                ...
                If Correct.Visible = True Or choice = answer Then
                    ...
                    End If
                Else
                    'play Question 6 Incorrect
                    My.Computer.Audio.Play(My.Resources.Question6Wrong, AudioPlayMode.Background)
    ...
    Sub FinalAnswer()
        ...
        Else
            'play the question 6 Final Answer
            My.Computer.Audio.Play(My.Resources.Question6Final, AudioPlayMode.Background)
        End If
    ...
    Sub QuestionResult()
        ...
        If choice = answer Then
            ...
            Level3MoneyTree.Topic06.BackColor = Color.Green
            Level3MoneyTree.Topic06.ForeColor = Color.White
            Level4MoneyTree.Topic06.BackColor = Color.Green
            Level4MoneyTree.Topic06.ForeColor = Color.White
            PlayerScreen.Topic06.BackColor = Color.Green
            PlayerScreen.Topic06.ForeColor = Color.White
        Else
            'change the color of the topic to red
            Level3MoneyTree.Topic06.BackColor = Color.Red
            Level3MoneyTree.Topic06.ForeColor = Color.White
            Level4MoneyTree.Topic06.BackColor = Color.Red
            Level4MoneyTree.Topic06.ForeColor = Color.White
            PlayerScreen.Topic06.BackColor = Color.Red
            PlayerScreen.Topic06.ForeColor = Color.White
        End If
    End Sub
