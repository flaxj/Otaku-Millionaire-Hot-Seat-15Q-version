...
Public Class Q10
    Friend Q10GamePlay(13) As String 'declare gameplay as string
    ...
    Private Sub Q10_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'transfer Friend Varables from Question 9
        GPlayersRemaining = Q09.GPlayersRemaining
        GPlayerNumber = Q09.GPlayerNumber
        questionsRemaining = Q09.questionsRemaining
        SHQuestionsRemaining = Q09.SHQuestionsRemaining
        passUsage = Q09.passUsage
        AskFriendCount = Q09.AskFriendCount
        DoubleDipCount = Q09.DoubleDipCount
        TopPrizeAmount.Text = Q09.TopPrizeAmount.Text
        Trust = Q09.Trust

        Winnings.question = 10
        ...
        If GPlayersRemaining = 6 Then
            ...
            'set QuestionValue to Question 10 Value
        ...
        ElseIf GPlayersRemaining = 2 Then
            If Q09.QuestionValue.Text = "¥1,000" Then
    ...
    Sub QuestionLoading()
        ...
        Topic.Text = Q10GamePlay(0)
        Question1.Text = Q10GamePlay(1)
        Question2.Text = Q10GamePlay(2)
        Question3.Text = Q10GamePlay(3)
        ChoiceA.Text = Q10GamePlay(4)
        ChoiceB.Text = Q10GamePlay(5)
        ChoiceC.Text = Q10GamePlay(6)
        ChoiceD.Text = Q10GamePlay(7)
        PlayerScreen.Topic.Text = Q10GamePlay(0)
        PlayerScreen.question(0) = Q10GamePlay(1)
        PlayerScreen.question(1) = Q10GamePlay(2)
        PlayerScreen.question(2) = Q10GamePlay(3)
        PlayerScreen.question(3) = Q10GamePlay(4)
        PlayerScreen.question(4) = Q10GamePlay(5)
        PlayerScreen.question(5) = Q10GamePlay(6)
        PlayerScreen.question(6) = Q10GamePlay(7)

        'load the question on the PlayerScreen
        PlayerScreen.QuestionLoader()

        'set the answer
        answer = Q10GamePlay(8)

        'convert the choice text numbers
        CountA = CInt(Q10GamePlay(9))
        CountB = CInt(Q10GamePlay(10))
        CountC = CInt(Q10GamePlay(11))
        CountD = CInt(Q10GamePlay(12))
    ...
    Private Sub MasterButton_Click(sender As Object, e As EventArgs) Handles MasterButton.Click
        Select Case ButtonCount
            ...
            Case 1
                ...
                'start Question 10 Music
                My.Computer.Audio.Stop()
                My.Computer.Audio.Play(My.Resources.Question10, AudioPlayMode.Background)
            ...
            Case 2
                ...
                Else
                    ...
                    My.Computer.Audio.Play(My.Resources.Question10Wrong, AudioPlayMode.Background)
    ...
    Sub FinalAnswer()
        ...
        Else
            'play the question 10 Final Answer
            My.Computer.Audio.Play(My.Resources.Question10Final, AudioPlayMode.Background)
        End If
    ...
    Sub QuestionResult()
        ...
        If choice = answer Then
            ...
            Level3MoneyTree.Topic10.BackColor = Color.Green
            Level3MoneyTree.Topic10.ForeColor = Color.White
            Level4MoneyTree.Topic10.BackColor = Color.Green
            Level4MoneyTree.Topic10.ForeColor = Color.White
            PlayerScreen.Topic10.BackColor = Color.Green
            PlayerScreen.Topic10.ForeColor = Color.White
        Else
            'change the color of the topic to red
            Level3MoneyTree.Topic10.BackColor = Color.Red
            Level3MoneyTree.Topic10.ForeColor = Color.White
            Level4MoneyTree.Topic10.BackColor = Color.Red
            Level4MoneyTree.Topic10.ForeColor = Color.White
            PlayerScreen.Topic10.BackColor = Color.Red
            PlayerScreen.Topic10.ForeColor = Color.White
        End If
    End Sub
    ...
    Sub RestartQuestionClock()
        ...
        If TimeSeconds = 30 Then
            My.Computer.Audio.Play(My.Resources.Question10, AudioPlayMode.Background)
        Else
            My.Computer.Audio.Play(My.Resources.Question10_15, AudioPlayMode.Background)
        End If
    End Sub
