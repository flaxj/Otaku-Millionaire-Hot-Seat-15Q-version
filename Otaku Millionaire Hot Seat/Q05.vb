Public Class Q05
    Friend Q5GamePlay(13) As String 'declare gameplay as string
    ...
    Private Sub Q05_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'transfer Friend Varables from Question 4
        GPlayersRemaining = Q04.GPlayersRemaining
        GPlayerNumber = Q04.GPlayerNumber
        questionsRemaining = Q04.questionsRemaining
        SHQuestionsRemaining = Q04.SHQuestionsRemaining
        passUsage = Q04.passUsage
        AskFriendCount = Q04.AskFriendCount
        DoubleDipCount = Q04.DoubleDipCount
        TopPrizeAmount.Text = Q04.TopPrizeAmount.Text
        Trust = Q04.Trust
        ...
        If GPlayersRemaining = 6 Then
            ...
            'set QuestionValue to Question 5 Value
        ...
        ElseIf GPlayersRemaining = 4 Then
            If Q04.QuestionValue.Text = "¥1,000" Then
    ...
    Sub QuestionLoading()
        ...
        Topic.Text = Q5GamePlay(0)
        Question1.Text = Q5GamePlay(1)
        Question2.Text = Q5GamePlay(2)
        Question3.Text = Q5GamePlay(3)
        ChoiceA.Text = Q5GamePlay(4)
        ChoiceB.Text = Q5GamePlay(5)
        ChoiceC.Text = Q5GamePlay(6)
        ChoiceD.Text = Q5GamePlay(7)
        PlayerScreen.Topic.Text = Q5GamePlay(0)
        PlayerScreen.question(0) = Q5GamePlay(1)
        PlayerScreen.question(1) = Q5GamePlay(2)
        PlayerScreen.question(2) = Q5GamePlay(3)
        PlayerScreen.question(3) = Q5GamePlay(4)
        PlayerScreen.question(4) = Q5GamePlay(5)
        PlayerScreen.question(5) = Q5GamePlay(6)
        PlayerScreen.question(6) = Q5GamePlay(7)
        ...
        CountA = CInt(Q5GamePlay(9))
        CountB = CInt(Q5GamePlay(10))
        CountC = CInt(Q5GamePlay(11))
        CountD = CInt(Q5GamePlay(12))
    ...
    Private Sub MasterButton_Click(sender As Object, e As EventArgs) Handles MasterButton.Click
        Select Case ButtonCount
            ...
            Case 1
                ...
                'start Question 5 Music
                My.Computer.Audio.Stop()
                My.Computer.Audio.Play(My.Resources.Question5, AudioPlayMode.Background)
            ...
            Case 2
                ...
                If Correct.Visible = True Or choice = answer Then
                    ...
                    Else
                        'play Question 5 Correct Answer
                        My.Computer.Audio.Play(My.Resources.Question5Correct, AudioPlayMode.Background)
                    End If
                    ...
                    End If
                Else
                    'play Question 5 Incorrect
                    My.Computer.Audio.Play(My.Resources.Question5Wrong, AudioPlayMode.Background)
    ...
    Sub FinalAnswer()
        ...
        Else
            'play the question 5 Final Answer
            My.Computer.Audio.Play(My.Resources.Question5Final, AudioPlayMode.Background)
        End If
    ...
    Sub QuestionResult()
        ...
        If choice = answer Then
            ...
            Level3MoneyTree.Topic05.BackColor = Color.Green
            Level3MoneyTree.Topic05.ForeColor = Color.White
            Level4MoneyTree.Topic05.BackColor = Color.Green
            Level4MoneyTree.Topic05.ForeColor = Color.White
            PlayerScreen.Topic05.BackColor = Color.Green
            PlayerScreen.Topic05.ForeColor = Color.White
        Else
            'change the color of the topic to red
            Level3MoneyTree.Topic05.BackColor = Color.Red
            Level3MoneyTree.Topic05.ForeColor = Color.White
            Level4MoneyTree.Topic05.BackColor = Color.Red
            Level4MoneyTree.Topic05.ForeColor = Color.White
            PlayerScreen.Topic05.BackColor = Color.Red
            PlayerScreen.Topic05.ForeColor = Color.White
        End If
    End Sub
    ...
    Sub RestartQuestionClock()
        ...
        If TimeSeconds = 30 Then
            My.Computer.Audio.Play(My.Resources.Question5, AudioPlayMode.Background)
        Else
            My.Computer.Audio.Play(My.Resources.Question5_15, AudioPlayMode.Background)
        End If
    End Sub
