Public Class Q08
    ...
    Sub QuestionLoading()
        ...
        Topic.Text = Q8GamePlay(0)
        Question1.Text = Q8GamePlay(1)
        Question2.Text = Q8GamePlay(2)
        Question3.Text = Q8GamePlay(3)
        ChoiceA.Text = Q8GamePlay(4)
        ChoiceB.Text = Q8GamePlay(5)
        ChoiceC.Text = Q8GamePlay(6)
        ChoiceD.Text = Q8GamePlay(7)
        PlayerScreen.Topic.Text = Q8GamePlay(0)
        PlayerScreen.question(0) = Q8GamePlay(1)
        PlayerScreen.question(1) = Q8GamePlay(2)
        PlayerScreen.question(2) = Q8GamePlay(3)
        PlayerScreen.question(3) = Q8GamePlay(4)
        PlayerScreen.question(4) = Q8GamePlay(5)
        PlayerScreen.question(5) = Q8GamePlay(6)
        PlayerScreen.question(6) = Q8GamePlay(7)
        ...
        CountA = CInt(Q8GamePlay(9))
        CountB = CInt(Q8GamePlay(10))
        CountC = CInt(Q8GamePlay(11))
        CountD = CInt(Q8GamePlay(12))
    ...
    Sub FinalAnswer()
        ...
        Else
            'play the question 8 Final Answer
            My.Computer.Audio.Play(My.Resources.Question8Final, AudioPlayMode.Background)
        End If
