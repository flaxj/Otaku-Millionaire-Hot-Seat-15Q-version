Public Class Q04
    ...
    Private Sub Q04_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        AskFriendCount = Q03.AskFriendCount
        DoubleDipCount = Q03.DoubleDipCount
    ...
    Private Sub MasterButton_Click(sender As Object, e As EventArgs) Handles MasterButton.Click
        Select Case ButtonCount
            ...
            Case 1
                ...
                'start Question 4 Music
                My.Computer.Audio.Stop()
                My.Computer.Audio.Play(My.Resources.Question4, AudioPlayMode.Background)
            ...
            Case 2
                ...
                If Correct.Visible = True Or choice = answer Then
                    ...
                    Else
                        'play Question 4 Correct Answer
                        My.Computer.Audio.Play(My.Resources.Question4Correct, AudioPlayMode.Background)
                    End If
                    ...
                    End If
                Else
                    'play Question 4 Incorrect
                    My.Computer.Audio.Play(My.Resources.Question4Wrong, AudioPlayMode.Background)
    ...
    Sub FinalAnswer()
        ...
        Else
            'play the question 4 Final Answer
            My.Computer.Audio.Play(My.Resources.Question4Final, AudioPlayMode.Background)
        End If
    ...
    Sub RestartQuestionClock()
        ...
        If TimeSeconds = 30 Then
            My.Computer.Audio.Play(My.Resources.Question4, AudioPlayMode.Background)
        Else
            My.Computer.Audio.Play(My.Resources.Question4_15, AudioPlayMode.Background)
        End If
    End Sub
