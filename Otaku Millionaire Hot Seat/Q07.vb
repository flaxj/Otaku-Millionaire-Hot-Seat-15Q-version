Public Class Q07
    ...
    Private Sub Q07_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'transfer Friend Varables from Question 6
        GPlayersRemaining = Q06.GPlayersRemaining
        GPlayerNumber = Q06.GPlayerNumber
        questionsRemaining = Q06.questionsRemaining
        SHQuestionsRemaining = Q06.SHQuestionsRemaining
        passUsage = Q06.passUsage
        AskFriendCount = Q06.AskFriendCount
        DoubleDipCount = Q06.DoubleDipCount
    ...
    Sub QuestionLoading()
        ...
        Topic.Text = Q7GamePlay(0)
        Question1.Text = Q7GamePlay(1)
        Question2.Text = Q7GamePlay(2)
        Question3.Text = Q7GamePlay(3)
        ChoiceA.Text = Q7GamePlay(4)
        ChoiceB.Text = Q7GamePlay(5)
        ChoiceC.Text = Q7GamePlay(6)
        ChoiceD.Text = Q7GamePlay(7)
        PlayerScreen.Topic.Text = Q7GamePlay(0)
        PlayerScreen.question(0) = Q7GamePlay(1)
        PlayerScreen.question(1) = Q7GamePlay(2)
        PlayerScreen.question(2) = Q7GamePlay(3)
        PlayerScreen.question(3) = Q7GamePlay(4)
        PlayerScreen.question(4) = Q7GamePlay(5)
        PlayerScreen.question(5) = Q7GamePlay(6)
        PlayerScreen.question(6) = Q7GamePlay(7)
        ...
        CountA = CInt(Q7GamePlay(9))
        CountB = CInt(Q7GamePlay(10))
        CountC = CInt(Q7GamePlay(11))
        CountD = CInt(Q7GamePlay(12))
    ...
    Sub FinalAnswer()
        ...
        Else
            'play the question 7 Final Answer
            My.Computer.Audio.Play(My.Resources.Question7Final, AudioPlayMode.Background)
        End If
    ...
    Sub QuestionResult()
        ...
        If choice = answer Then
            ...
            Level3MoneyTree.Topic07.BackColor = Color.Green
            Level3MoneyTree.Topic07.ForeColor = Color.White
            Level4MoneyTree.Topic07.BackColor = Color.Green
            Level4MoneyTree.Topic07.ForeColor = Color.White
            PlayerScreen.Topic07.BackColor = Color.Green
            PlayerScreen.Topic07.ForeColor = Color.White
        Else
            'change the color of the topic to red
            Level3MoneyTree.Topic07.BackColor = Color.Red
            Level3MoneyTree.Topic07.ForeColor = Color.White
            Level4MoneyTree.Topic07.BackColor = Color.Red
            Level4MoneyTree.Topic07.ForeColor = Color.White
            PlayerScreen.Topic07.BackColor = Color.Red
            PlayerScreen.Topic07.ForeColor = Color.White
        End If
    End Sub
