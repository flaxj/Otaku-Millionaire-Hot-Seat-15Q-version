Partial Public Class Q14
    Inherits Global.System.Windows.Forms.Form

    Friend Q14GamePlay(13) As String 'declare gameplay as string
    ...
    Private Sub Q14_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'transfer Friend Varables from Question 13
        GPlayersRemaining = Q13.GPlayersRemaining
        GPlayerNumber = Q13.GPlayerNumber
        questionsRemaining = Q13.questionsRemaining
        AskFriendCount = Q13.AskFriendCount
        DoubleDipCount = Q13.DoubleDipCount
        AskAudienceCount = Q13.AskAudienceCount
        TopPrizeAmount.Text = Q13.TopPrizeAmount.Text
        Trust = Q13.Trust

        Winnings.question = 14
        ...
        If GPlayersRemaining = 6 Then
            'set QuestionValue to Question 14 Value
            QuestionValue.Text = "¥250,000"
    ...
    Sub QuestionLoading()
        ...
        Topic.Text = Q14GamePlay(0)
        Question1.Text = Q14GamePlay(1)
        Question2.Text = Q14GamePlay(2)
        Question3.Text = Q14GamePlay(3)
        ChoiceA.Text = Q14GamePlay(4)
        ChoiceB.Text = Q14GamePlay(5)
        ChoiceC.Text = Q14GamePlay(6)
        ChoiceD.Text = Q14GamePlay(7)
        PlayerScreen.Topic.Text = Q14GamePlay(0)
        PlayerScreen.question(0) = Q14GamePlay(1)
        PlayerScreen.question(1) = Q14GamePlay(2)
        PlayerScreen.question(2) = Q14GamePlay(3)
        PlayerScreen.question(3) = Q14GamePlay(4)
        PlayerScreen.question(4) = Q14GamePlay(5)
        PlayerScreen.question(5) = Q14GamePlay(6)
        PlayerScreen.question(6) = Q14GamePlay(7)

        'load the question on the PlayerScreen
        PlayerScreen.QuestionLoader()

        'set the answer
        answer = Q14GamePlay(8)

        'convert the choice text numbers
        CountA = CInt(Q14GamePlay(9))
        CountB = CInt(Q14GamePlay(10))
        CountC = CInt(Q14GamePlay(11))
        CountD = CInt(Q14GamePlay(12))
    ...
    Private Sub MasterButton_Click(sender As Object, e As EventArgs) Handles MasterButton.Click
        Select Case ButtonCount
            ...
            Case 1
                ...
                'start Question 14 Music
                My.Computer.Audio.Stop()
                My.Computer.Audio.Play(My.Resources.Questions14and15, AudioPlayMode.Background)
            ...
            Case 2
                ...
                If Correct.Visible = True Or choice = answer Then
                    ...
                    Else
                        'play Question 14 Correct Answer
                        My.Computer.Audio.Play(My.Resources.Question14Correct, AudioPlayMode.Background)
                    End If
                ...
                Else
                    ...
                    My.Computer.Audio.Play(My.Resources.Questions14and15Wrong, AudioPlayMode.Background)
            ...
            Case 3
                ...
                Else
                    ...
                    'open the Level 4 Window 
                    Level4MoneyTree.Show()
                End If
            Case 4
                'level window
                PlayerScreen.LevelWindow()
    ...
    Sub FinalAnswer()
        ...
        My.Computer.Audio.Stop()
        If DoubleDipPic.Visible = True And guess = 1 Then
            'play the first double dip final answer
            My.Computer.Audio.Play(My.Resources.DoubleDipFinalAnswer, AudioPlayMode.Background)
        Else
            'play the Question 14 Final Answer
            My.Computer.Audio.Play(My.Resources.Questions14and15FinalAnswer, AudioPlayMode.Background)
        End If
        ...
        If guess = 1 And DoubleDipPic.Visible = True Then
            'disable the MasterButton
            MasterButton.Enabled = False
        Else
    ...
    Sub QuestionResult()
        ...
        If choice = answer Then
            ...
            Level4MoneyTree.Topic14.BackColor = Color.Green
            Level4MoneyTree.Topic14.ForeColor = Color.White
            PlayerScreen.Topic14.BackColor = Color.Green
            PlayerScreen.Topic14.ForeColor = Color.White
        Else
            'change the color of the topic to red
            Level4MoneyTree.Topic14.BackColor = Color.Red
            Level4MoneyTree.Topic14.ForeColor = Color.White
            PlayerScreen.Topic14.BackColor = Color.Red
            PlayerScreen.Topic14.ForeColor = Color.White
        End If
    End Sub
    ...
    Sub RestartQuestionClock()
        ...
        Select Case TimeSeconds
            Case 45
                My.Computer.Audio.Play(My.Resources.Questions14and15, AudioPlayMode.Background)
            Case 30
                My.Computer.Audio.Play(My.Resources.Questions14and15_30, AudioPlayMode.Background)
            Case 15
                My.Computer.Audio.Play(My.Resources.Questions14and15_15, AudioPlayMode.Background)
        End Select
    End Sub
